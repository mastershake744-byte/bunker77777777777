...
.catalog-desc{color:var(--muted);line-height:1.6;max-width:500px;margin-bottom:14px;white-space:pre-line}
...
.product-card-image img{width:85%;height:80%;object-fit:contain}
.product-badge{
